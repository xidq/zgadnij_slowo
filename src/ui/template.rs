...
pub fn templejt_3(proxy_self:&mut ZgadnijSlowo,ui:&mut Ui,_ctx: &egui::Context,słowo:&str){
...
pub fn templejt_4(proxy_self:&mut ZgadnijSlowo,ui:&mut Ui,_ctx: &egui::Context,słowo:&str){
...
pub fn templejt_5(proxy_self:&mut ZgadnijSlowo,ui:&mut Ui,_ctx: &egui::Context,słowo:&str){
